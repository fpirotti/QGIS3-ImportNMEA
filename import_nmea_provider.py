...
from .import_nmea_algorithm import ImportNMEAAlgorithm


class ImportNMEAProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(ImportNMEAAlgorithm())
